...
ALLOWLIST: tuple[Allowed, ...] = (
    ...
    Allowed(
        "gcp_grounding/sec_domains.py", 236, "_iterable(values)",
    ...
    Allowed(
        "gcp_grounding/sec_domains.py", 254, "_iterable(values)",
        "Same _iterable laundering, in the string-dimension builder.",
    ),
    Allowed(
        "gcp_grounding/sec_domains.py", 260, "_iterable(entries)",
        "Same _iterable laundering, in the layer-4 dimension builder.",
    ),
    Allowed(
        "gcp_grounding/sec_domains.py", 314, "_iterable(ports)",
